...
export JENKINS_SERVICE_HOST=${JENKINS_SERVICE_HOST:=}
export JENKINS_SERVICE_PORT=${JENKINS_SERVICE_PORT:=}

export JENKINS_TUNNEL=${JENKINS_TUNNEL:=}

export JENKINS_SLAVE_SERVICE_HOST=${JENKINS_SLAVE_SERVICE_HOST:=}
export JENKINS_SLAVE_SERVICE_PORT=${JENKINS_SLAVE_SERVICE_PORT:=}
